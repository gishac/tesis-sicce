...
CREATE TABLE ZONE (
  ID_ZONE INTEGER ZEROFILL NOT NULL AUTO_INCREMENT,
  CODE VARCHAR(6)) NULL,
  DESCRIPTION VARCHAR(20) NULL,
  PRIMARY KEY(ID_ZONE)
);
...
CREATE TABLE USER_SICCE (
  ...
  _ID_ROLE INTEGER UNSIGNED NOT NULL,
  NAME VARCHAR(20) NULL,
  LASTNAME VARCHAR(20) NULL,
  CODE_UCSG INTEGER UNSIGNED NULL,
  USERNAME_SICCE VARCHAR NULL,
  PASSWORD_SICCE VARCHAR(20) NULL,
  PRIMARY KEY(ID_USER_SICCE),
  INDEX USER_SICCE_FKIndex1(_ID_ROLE),
...
CREATE TABLE LOCATION_ZONE (
  ...
  ID_ZONE INTEGER ZEROFILL NOT NULL,
