...
CREATE TABLE REPORT(
  ID_REPORT INTEGER UNSIGNED NOT NULL,
  ID_OPTION_SICCE INTEGER UNSIGNED NOT NULL,
  REPORT_NAME VARCHAR(30) NOT NULL,
  REPORT_DESCRIPTION VARCHAR(80),
  REPORT_JRXML BLOB,
  PRIMARY KEY  (ID_REPORT, ID_OPTION_SICCE),
  KEY `REPORT_FKIndex1` (ID_OPTION_SICCE),
  CONSTRAINT report_FKIndex1_ibfk FOREIGN KEY (ID_OPTION_SICCE) REFERENCES OPTION_SICCE (ID_OPTION_SICCE) ON DELETE CASCADE ON UPDATE NO ACTION
);
