...
public class RoleDAO extends HibernateDaoSupport {
    ...
    public void save(IRole transientInstance) {
    ...
    public void delete(IRole persistentInstance) {
    ...
    public IRole findById(java.lang.Integer id) {
        log.debug("getting Role instance with id: " + id);
        try {
            IRole instance = (IRole) getHibernateTemplate().get(
                    "sicce.api.info.Role", id);
            return instance;
        } catch (RuntimeException re) {
